  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="card-deep rounded-3xl p-12 md:p-16 text-center relative overflow-hidden">
          {/* Glow */}
          ...
          <div className="relative">
            ...
            <h2 className="font-display text-3xl md:text-5xl text-cream-100 mb-6 leading-tight">
              Who do you want to write a song for?
            </h2>
            <p className="text-cream-200/60 max-w-xl mx-auto mb-10">
